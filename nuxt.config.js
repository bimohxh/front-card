...
module.exports = {
  ...
  */
  ...
  plugins: ['~/plugins/icon', '~/plugins/common', { src: '~/plugins/ba.js', ssr: false }, { src: '~/plugins/pagination.js', ssr: false }, { src: '~/plugins/upload', ssr: false }, { src: '~/plugins/i18n.js', injectAs: 'i18n' }]
}
